...
export const PurposeSection: FC = () => {
  ...
  return (
    <section
      ...
      data-oid="pt8qwqu"
    >
      <div className="max-w-6xl mx-auto" data-oid=":bgn9yb">
        <h1
        ...
        <div
          ...
          data-oid="7vizlb7"
        >
          <p className="text-center max-w-3xl mx-auto" data-oid="pb9zvyy">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12" data-oid="myyobh9">
            {featureCards.map((card, index) => (
              <div
                ...
                data-oid="7vefd.2"
              >
                <h3 className="text-2xl font-semibold mb-4" data-oid="c31xh_r">
                  <span
