...
export const PurposeSection: FC = () => {
  ...
  return (
    <section
      ...
      data-oid="_pt3th8"
    >
      <div className="max-w-6xl mx-auto" data-oid="d0n4vr8">
        <h1
        ...
        <div
          ...
          data-oid="siwo-no"
        >
          <p className="text-center max-w-3xl mx-auto" data-oid="8txz_jg">
          ...
          <div className="grid md:grid-cols-2 gap-8 mt-12" data-oid="j2umvo:">
            {featureCards.map((card, index) => (
              <div
                ...
                data-oid="u0al0qw"
              >
                <h3 className="text-2xl font-semibold mb-4" data-oid="y_pr:ag">
                  <span
