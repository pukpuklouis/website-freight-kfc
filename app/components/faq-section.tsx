...
export function FAQSection({
  ...
  return (
    <section className="px-[5%] py-24 bg-[var(--accent-2)]" data-oid="3awv2h1">
      <div className="container mx-auto max-w-4xl" data-oid="okzgtsp">
        <div className="text-center mb-16" data-oid="-4jnbr8">
          <h2
        ...
        <div className="space-y-4" data-oid="5m-37_d">
          {questions.map((question, index) => (
            ...
            >
              ...
              <AnimatePresence data-oid="mct0ywj">
        ...
        <div className="mt-16 text-center" data-oid="mf4-rys">
          <h3
          ...
          <p className="text-[var(--gray-11)] mb-8" data-oid="9m048:f">
            {footerDescription}
          </p>
          <a
            href="/contact-us"
