...
const defaultSteps: TimelineItem[] = [
  {
    ...
    icon: <Package2 className="w-6 h-6" data-oid="f3qkdle" />,
  },
  {
    title: "集散倉庫",
    description:
      "貨物會被集中到我們的集散倉庫，進行整理和分類。這樣可以提高運輸效率，確保每一件貨物都能準時發送。",
    icon: <Warehouse className="w-6 h-6" data-oid=":-mm-xy" />,
  },
  {
    title: "運輸安排",
    description:
      "我們根據客戶的需求制定運輸計劃，選擇最佳的運輸方式。無論是空運還是海運，我們都能提供適治的解決方案。",
    icon: <Truck className="w-6 h-6" data-oid="bgdf556" />,
  },
  {
    title: "準時交付",
    description:
      "我們的專業團隊確保貨物時刻送達客戶手中。客戶可以隨時追蹤貨物狀態，享受無縫的物流體驗。",
    icon: <Clock className="w-6 h-6" data-oid="63fdcc9" />,
  },
];
...
const TimelineStep = memo(function TimelineStep({
  ...
  return (
    ...
    >
      ...
      <div className="relative flex gap-6 pb-8" data-oid="czzhxab">
        {/* Icon */}
        <div className="relative" data-oid="0lb:2v:">
          <motion.div
            initial={{ scale: 0 }}
            whileInView={{ scale: 1 }}
            viewport={{ once: false, margin: "-100px" }}
        ...
        {/* Content */}
        <div className="flex-1 pt-1.5" data-oid="gjf22h9">
          <motion.h3
...
export const HowItWorks = memo(function HowItWorks({
  ...
  return (
    <section
      ...
      data-oid="h50.a_2"
    >
      <div className="container mx-auto" data-oid="4ls9m.6">
        <div
          className="grid lg:grid-cols-2 gap-12 items-start"
          data-oid="wq_c3zq"
        >
          {/* Left Column - Content */}
          <div className="lg:sticky lg:top-8" data-oid="vtu09.e">
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: false }}
          ...
          <div className="relative" data-oid="3vv4pfc">
